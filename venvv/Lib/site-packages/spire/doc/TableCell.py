...
class TableCell (  Body, IDocumentObject) :
    ...
    def Width(self)->float:
        ...
        """
        warnings.warn("'TableCell.Width' is obsolete: 'The get accessor for this property is obsolete. Call GetCellWidth() instead.", DeprecationWarning)
    ...
    def Width(self, value:float):
        ...
        """
        warnings.warn("'TableCell.Width' is obsolete: 'The set accessor for this property is obsolete. Call SetCellWidth() instead.", DeprecationWarning)
    ...
    def CellWidthType(self)->'CellWidthType':
        ...
        """
        warnings.warn("'TableCell.CellWidthType' is obsolete: 'The get accessor for this property is obsolete. Call GetCellWidthType() instead.", DeprecationWarning)
    ...
    def CellWidthType(self, value:'CellWidthType'):
        ...
        """
        warnings.warn("'TableCell.CellWidthType' is obsolete: The set accessor for this property is obsolete. Call SetCellWidth() instead.", DeprecationWarning)
