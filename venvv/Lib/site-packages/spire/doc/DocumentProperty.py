...
class DocumentProperty (SpireObject) :
    ...
    def Value(self)-> object:
        ...
        if intPtr == None:
            return None
        elif self.ValueType == PropertyValueType.Boolean:
            return self.ToBool()
        elif self.ValueType == PropertyValueType.Date:
            return self.ToDateTime()
        elif self.ValueType == PropertyValueType.Float:
            return self.ToFloat()
        elif self.ValueType == PropertyValueType.Double:
            return self.ToDouble()
        elif self.ValueType == PropertyValueType.Int:
            return self.ToInt()
        elif self.ValueType == PropertyValueType.String:
            return self.ToString()
        else: 
            return SpireObject(intPtr)
    ...
    def Value(self, value: object):
        ...
        CallCFunction(GetDllLibDoc().DocumentProperty_set_Value,self.Ptr, intPtrvalue)
