...
class Field (  TextRange, IField) :
    ...
    def GetFieldCode(self) -> str:
        ...
        """
        GetDllLibDoc().Field_GetFieldCode.argtypes=[c_void_p]
        GetDllLibDoc().Field_GetFieldCode.restype=c_void_p
        ret = PtrToStr(CallCFunction(GetDllLibDoc().Field_GetFieldCode,self.Ptr))
        return ret
    @property
