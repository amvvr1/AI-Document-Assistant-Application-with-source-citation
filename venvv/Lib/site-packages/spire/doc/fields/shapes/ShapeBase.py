...
class ShapeBase (  ParagraphBase) :
    ...
    def AllowOverlap(self)->bool:
        """
        Gets the boolean a  value. Specifies whether this shape can overlap other shapes.
        """
        GetDllLibDoc().ShapeBase_get_AllowOverlap.argtypes=[c_void_p]
        GetDllLibDoc().ShapeBase_get_AllowOverlap.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().ShapeBase_get_AllowOverlap,self.Ptr)
        return ret

    @AllowOverlap.setter
    def AllowOverlap(self, value:bool):
        """
        Sets the boolean a  value. Specifies whether this shape can overlap other shapes.
        """
        GetDllLibDoc().ShapeBase_set_AllowOverlap.argtypes=[c_void_p, c_bool]
        CallCFunction(GetDllLibDoc().ShapeBase_set_AllowOverlap,self.Ptr, value)

    @property
    def BehindText(self)->bool:
        """
        Gets the boolean a valut. Specifies whether the shape is below or above text.
        """
        GetDllLibDoc().ShapeBase_get_BehindText.argtypes=[c_void_p]
        GetDllLibDoc().ShapeBase_get_BehindText.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().ShapeBase_get_BehindText,self.Ptr)
        return ret

    @BehindText.setter
    def BehindText(self, value:bool):
        """
        Sets the boolean a valut. Specifies whether the shape is below or above text.
        """
        GetDllLibDoc().ShapeBase_set_BehindText.argtypes=[c_void_p, c_bool]
        CallCFunction(GetDllLibDoc().ShapeBase_set_BehindText,self.Ptr, value)
    ...
    def HRef(self)->str:
        ...
        returns: The hyperlink address of the shape.
        
        """
        GetDllLibDoc().ShapeBase_get_HRef.argtypes=[c_void_p]
        GetDllLibDoc().ShapeBase_get_HRef.restype=c_void_p
        ret = PtrToStr(CallCFunction(GetDllLibDoc().ShapeBase_get_HRef,self.Ptr))
        return ret
    ...
    def HRef(self, value:str):
        valuePtr=StrToPtr(value)
        GetDllLibDoc().ShapeBase_set_HRef.argtypes=[c_void_p, c_char_p]
        CallCFunction(GetDllLibDoc().ShapeBase_set_HRef,self.Ptr, valuePtr)
    ...
    def HasHyperlink(self)->bool:
        ...
        """
        GetDllLibDoc().ShapeBase_get_HasHyperlink.argtypes=[c_void_p]
        GetDllLibDoc().ShapeBase_get_HasHyperlink.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().ShapeBase_get_HasHyperlink,self.Ptr)
        return ret