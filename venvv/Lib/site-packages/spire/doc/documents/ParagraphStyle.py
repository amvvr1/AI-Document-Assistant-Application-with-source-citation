...
class ParagraphStyle (  Style, IParagraphStyle) :
    ...
    def CharacterFormat(self)->'CharacterFormat':
        ...
        """
        GetDllLibDoc().ParagraphStyle_get_CharacterFormat.argtypes=[c_void_p]
        GetDllLibDoc().ParagraphStyle_get_CharacterFormat.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().ParagraphStyle_get_CharacterFormat,self.Ptr)
    ...
    def Frame(self)->'Frame':
        ...
        """
        GetDllLibDoc().ParagraphStyle_get_Frame.argtypes=[c_void_p]
        GetDllLibDoc().ParagraphStyle_get_Frame.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().ParagraphStyle_get_Frame,self.Ptr)
