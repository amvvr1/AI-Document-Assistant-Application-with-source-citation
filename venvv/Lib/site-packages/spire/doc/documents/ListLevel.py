...
class ListLevel (  DocumentSerializable) :
    ...
    def DeletePictureBullet(self):
        """
        Deletes the picture bullet and resets the bullet properties to default values.
        """
        GetDllLibDoc().ListLevel_DeletePictureBullet.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().ListLevel_DeletePictureBullet,self.Ptr)

    def CreatePictureBullet(self):
        """
        Creates a picture bullet in the document.
        """
        GetDllLibDoc().ListLevel_CreatePictureBullet.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().ListLevel_CreatePictureBullet,self.Ptr)


    def Equals(self ,level:'ListLevel')->bool:
        """
        Determines whether the specified ListLevel is considered equal to the current instance.
        """
        intPtrlevel:c_void_p = level.Ptr

        GetDllLibDoc().ListLevel_Equals.argtypes=[c_void_p ,c_void_p]
        GetDllLibDoc().ListLevel_Equals.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().ListLevel_Equals,self.Ptr, intPtrlevel)
        return ret
    ...
    def PictureBullet(self)->'DocPicture':
        """
        Gets the picture bullet associated with the current object.
        """
        GetDllLibDoc().ListLevel_get_PictureBullet.argtypes=[c_void_p]
        GetDllLibDoc().ListLevel_get_PictureBullet.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().ListLevel_get_PictureBullet,self.Ptr)
