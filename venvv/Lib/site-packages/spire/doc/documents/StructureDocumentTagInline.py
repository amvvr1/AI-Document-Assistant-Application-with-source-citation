...
class StructureDocumentTagInline (  ParagraphBase, IStructureDocument) :
    """
    ...
    def RemoveSelfOnly(self):
        ...
        """
        GetDllLibDoc().StructureDocumentTagInline_RemoveSelfOnly.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().StructureDocumentTagInline_RemoveSelfOnly,self.Ptr)
