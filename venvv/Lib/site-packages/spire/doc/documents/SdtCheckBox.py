...
class SdtCheckBox (  SdtControlProperties) :
    ...
    def Type(self)->'SdtType':
        ...
        """
        GetDllLibDoc().SdtCheckBox_get_Type.argtypes=[c_void_p]
        GetDllLibDoc().SdtCheckBox_get_Type.restype=c_int
        ret = CallCFunction(GetDllLibDoc().SdtCheckBox_get_Type,self.Ptr)
