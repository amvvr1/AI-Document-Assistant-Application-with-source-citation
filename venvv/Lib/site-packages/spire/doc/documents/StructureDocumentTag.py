...
class StructureDocumentTag (  BodyRegion, IStructureDocument) :
    """
    ...
    def RemoveSelfOnly(self):
        ...
        """
        GetDllLibDoc().StructureDocumentTag_RemoveSelfOnly.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().StructureDocumentTag_RemoveSelfOnly,self.Ptr)
#    @dispatch
#
