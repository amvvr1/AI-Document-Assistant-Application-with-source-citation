...
class BodyRegion(CompositeDocumentObject, IBodyRegion):
    """
...
#        return ret
    ...
    def IsMoveFromRevision(self)->bool:
        ...
        """
        GetDllLibDoc().BodyRegion_get_IsMoveFromRevision.argtypes=[c_void_p]
        GetDllLibDoc().BodyRegion_get_IsMoveFromRevision.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().BodyRegion_get_IsMoveFromRevision,self.Ptr)
        return ret
    ...
    def MoveFromRevision(self)->'MoveRevision':
        ...
        """
        GetDllLibDoc().BodyRegion_get_MoveFromRevision.argtypes=[c_void_p]
        GetDllLibDoc().BodyRegion_get_MoveFromRevision.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().BodyRegion_get_MoveFromRevision,self.Ptr)
    ...
    def IsMoveToRevision(self)->bool:
        ...
        """
        GetDllLibDoc().BodyRegion_get_IsMoveToRevision.argtypes=[c_void_p]
        GetDllLibDoc().BodyRegion_get_IsMoveToRevision.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().BodyRegion_get_IsMoveToRevision,self.Ptr)
        return ret
    ...
    def MoveToRevision(self)->'MoveRevision':
        ...
        Note this can be null. If null does not have delete revision.
        """
        GetDllLibDoc().BodyRegion_get_MoveToRevision.argtypes=[c_void_p]
        GetDllLibDoc().BodyRegion_get_MoveToRevision.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().BodyRegion_get_MoveToRevision,self.Ptr)
        ret = None if intPtr==None else MoveRevision(intPtr)
        return ret
