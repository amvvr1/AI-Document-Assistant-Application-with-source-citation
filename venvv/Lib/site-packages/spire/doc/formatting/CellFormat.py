...
class CellFormat (  WordAttributeBase) :
    """
    ...
    def Shading(self)->'Shading':
        ...
        """
        GetDllLibDoc().CellFormat_get_Shading.argtypes=[c_void_p]
        GetDllLibDoc().CellFormat_get_Shading.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().CellFormat_get_Shading,self.Ptr)
    ...
    def ClearFormatting(self):
        ...
        """
        GetDllLibDoc().CellFormat_ClearFormatting.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().CellFormat_ClearFormatting,self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        GetDllLibDoc().CellFormat_Equals.argtypes=[c_void_p ,c_void_p]
        GetDllLibDoc().CellFormat_Equals.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().CellFormat_Equals,self.Ptr, intPtrobj)
        return ret
