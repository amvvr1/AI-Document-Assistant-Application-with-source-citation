...
class Paddings (  DocumentSerializable) :
    """
    ...
    def ClearFormatting(self):
        ...
        """
        GetDllLibDoc().Paddings_ClearFormatting.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().Paddings_ClearFormatting,self.Ptr)
