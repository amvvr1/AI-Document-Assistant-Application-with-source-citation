...
class ParagraphFormat (  WordAttributeBase) :
    """
    Represents the formatting options for a paragraph.
    """
    @property
    def BeforeSpacingLines(self)->float:
        """
        Gets a value specifies the spacing that should be added before the first line
        in this paragraph in the document in line units.
        """
        GetDllLibDoc().ParagraphFormat_get_BeforeSpacingLines.argtypes=[c_void_p]
        GetDllLibDoc().ParagraphFormat_get_BeforeSpacingLines.restype=c_float
        ret = CallCFunction(GetDllLibDoc().ParagraphFormat_get_BeforeSpacingLines,self.Ptr)
        return ret

    @BeforeSpacingLines.setter
    def BeforeSpacingLines(self, value:float):
        """
        Sets a value specifies the spacing that should be added before the first line
        in this paragraph in the document in line units.
        """
        GetDllLibDoc().ParagraphFormat_set_BeforeSpacingLines.argtypes=[c_void_p, c_float]
        CallCFunction(GetDllLibDoc().ParagraphFormat_set_BeforeSpacingLines,self.Ptr, value)

    @property
    def AfterSpacingLines(self)->float:
        """
        Gets a value specifies the spacing that should be added after the last line
        in this paragraph in the document in line units.
        """
        GetDllLibDoc().ParagraphFormat_get_AfterSpacingLines.argtypes=[c_void_p]
        GetDllLibDoc().ParagraphFormat_get_AfterSpacingLines.restype=c_float
        ret = CallCFunction(GetDllLibDoc().ParagraphFormat_get_AfterSpacingLines,self.Ptr)
        return ret

    @AfterSpacingLines.setter
    def AfterSpacingLines(self, value:float):
        """
        Sets a value specifies the spacing that should be added after the last line
        in this paragraph in the document in line units.
        """
        GetDllLibDoc().ParagraphFormat_set_AfterSpacingLines.argtypes=[c_void_p, c_float]
        CallCFunction(GetDllLibDoc().ParagraphFormat_set_AfterSpacingLines,self.Ptr, value)
    @property
    ...
    def ClearFormatting(self):
        ...
        """
        GetDllLibDoc().ParagraphFormat_ClearFormatting.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().ParagraphFormat_ClearFormatting,self.Ptr)
    ...
    @property
    def FirstLineIndentChars(self)->float:
        """
        Gets the value that represents the paragraph first line indent in character units.
        """
        GetDllLibDoc().ParagraphFormat_get_FirstLineIndentChars.argtypes=[c_void_p]
        GetDllLibDoc().ParagraphFormat_get_FirstLineIndentChars.restype=c_float
        ret = CallCFunction(GetDllLibDoc().ParagraphFormat_get_FirstLineIndentChars,self.Ptr)
        return ret

    @FirstLineIndentChars.setter
    def FirstLineIndentChars(self, value:float):
        """
            Sets the value that represents the paragraph first line indent in character units.
        """
        GetDllLibDoc().ParagraphFormat_set_FirstLineIndentChars.argtypes=[c_void_p, c_float]
        CallCFunction(GetDllLibDoc().ParagraphFormat_set_FirstLineIndentChars,self.Ptr, value)

    @property
    def LeftIndentChars(self)->float:
        """
            Gets the value that represents the paragraph left indent in character units.
        """
        GetDllLibDoc().ParagraphFormat_get_LeftIndentChars.argtypes=[c_void_p]
        GetDllLibDoc().ParagraphFormat_get_LeftIndentChars.restype=c_float
        ret = CallCFunction(GetDllLibDoc().ParagraphFormat_get_LeftIndentChars,self.Ptr)
        return ret

    @LeftIndentChars.setter
    def LeftIndentChars(self, value:float):
        """
            Sets the value that represents the paragraph left indent in character units.
        """
        GetDllLibDoc().ParagraphFormat_set_LeftIndentChars.argtypes=[c_void_p, c_float]
        CallCFunction(GetDllLibDoc().ParagraphFormat_set_LeftIndentChars,self.Ptr, value)

    @property
    def RightIndentChars(self)->float:
        """
            Gets the value that represents the paragraph right indent in character units.
        """
        GetDllLibDoc().ParagraphFormat_get_RightIndentChars.argtypes=[c_void_p]
        GetDllLibDoc().ParagraphFormat_get_RightIndentChars.restype=c_float
        ret = CallCFunction(GetDllLibDoc().ParagraphFormat_get_RightIndentChars,self.Ptr)
        return ret

    @RightIndentChars.setter
    def RightIndentChars(self, value:float):
        """
           Sets the value that represents the paragraph right indent in character units.
        """
        GetDllLibDoc().ParagraphFormat_set_RightIndentChars.argtypes=[c_void_p, c_float]
        CallCFunction(GetDllLibDoc().ParagraphFormat_set_RightIndentChars,self.Ptr, value)
    ...
    def IsFrame(self)->bool:
        ...
        """
        warnings.warn("This property is deprecated. Please call the 'Paragraph.Frame.IsFrame' property.", DeprecationWarning)
    ...
    def Frame(self)->'Frame':
        ...
        """
        warnings.warn("This property is deprecated. Please call the 'Paragraph.Frame' property.", DeprecationWarning)
    ...
    def Shading(self)->'Shading':
        ...
        """
        GetDllLibDoc().ParagraphFormat_get_Shading.argtypes=[c_void_p]
        GetDllLibDoc().ParagraphFormat_get_Shading.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().ParagraphFormat_get_Shading,self.Ptr)
    ...
    def Style(self)->'Style':
        ...
        """
        GetDllLibDoc().ParagraphFormat_get_Style.argtypes=[c_void_p]
        GetDllLibDoc().ParagraphFormat_get_Style.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().ParagraphFormat_get_Style,self.Ptr)
    ...
    def Style(self, value:'Style'):
        GetDllLibDoc().ParagraphFormat_set_Style.argtypes=[c_void_p, c_void_p]
        CallCFunction(GetDllLibDoc().ParagraphFormat_set_Style,self.Ptr, value.Ptr)
    ...
    def StyleName(self)->str:
        ...
        """
        GetDllLibDoc().ParagraphFormat_get_StyleName.argtypes=[c_void_p]
        GetDllLibDoc().ParagraphFormat_get_StyleName.restype=c_void_p
        ret = PtrToStr(CallCFunction(GetDllLibDoc().ParagraphFormat_get_StyleName,self.Ptr))
        return ret
    ...
    def StyleName(self, value:str):
        ...
        GetDllLibDoc().ParagraphFormat_set_StyleName.argtypes=[c_void_p, c_char_p]
        CallCFunction(GetDllLibDoc().ParagraphFormat_set_StyleName,self.Ptr, valuePtr)

    def HasKey(self ,propKey:int)->bool:
        """
        Determines if the property with the given key exists.

        args:
            propKey:The key of the property to check for existence.

        returns:
            True if the property with the specified key exists; otherwise, false.
        """
        GetDllLibDoc().ParagraphFormat_HasKey.argtypes=[c_void_p ,c_int]
        GetDllLibDoc().ParagraphFormat_HasKey.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().ParagraphFormat_HasKey,self.Ptr, propKey)
        return ret