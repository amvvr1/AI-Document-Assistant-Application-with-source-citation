...
class Border(InternalComplexAttribute):
    """
    Represents a border.
    """
    @property
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        GetDllLibDoc().Border_Equals.argtypes=[c_void_p ,c_void_p]
        GetDllLibDoc().Border_Equals.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().Border_Equals,self.Ptr, intPtrobj)
        return ret

    def GetHashCode(self)->int:
        """
        Calculates the hash code for the current object based on its properties.
        """
        GetDllLibDoc().Border_GetHashCode.argtypes=[c_void_p]
        GetDllLibDoc().Border_GetHashCode.restype=c_int
        ret = CallCFunction(GetDllLibDoc().Border_GetHashCode,self.Ptr)
        return ret
