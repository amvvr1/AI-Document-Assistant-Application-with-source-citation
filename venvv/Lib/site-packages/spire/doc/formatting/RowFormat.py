...
class RowFormat (  WordAttributeBase) :
    """
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        """
        Determines whether the specified <see cref="RowFormat" />, is equal to this instance.
        """
        intPtrobj:c_void_p = obj.Ptr

        GetDllLibDoc().RowFormat_Equals.argtypes=[c_void_p ,c_void_p]
        GetDllLibDoc().RowFormat_Equals.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().RowFormat_Equals,self.Ptr, intPtrobj)
        return ret
    ...
    def Height(self)->float:
        ...
        """
        GetDllLibDoc().RowFormat_get_Height.argtypes=[c_void_p]
        GetDllLibDoc().RowFormat_get_Height.restype=c_float
        ret = CallCFunction(GetDllLibDoc().RowFormat_get_Height,self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibDoc().RowFormat_set_Height.argtypes=[c_void_p, c_float]
        CallCFunction(GetDllLibDoc().RowFormat_set_Height,self.Ptr, value)
    ...
    def HeightType(self)->'TableRowHeightType':
        ...
        """
        GetDllLibDoc().RowFormat_get_HeightType.argtypes=[c_void_p]
        GetDllLibDoc().RowFormat_get_HeightType.restype=c_int
        ret = CallCFunction(GetDllLibDoc().RowFormat_get_HeightType,self.Ptr)
        objwraped = TableRowHeightType(ret)
        return objwraped

    @HeightType.setter
    def HeightType(self, value:'TableRowHeightType'):
        GetDllLibDoc().RowFormat_set_HeightType.argtypes=[c_void_p, c_int]
        CallCFunction(GetDllLibDoc().RowFormat_set_HeightType,self.Ptr, value.value)
    ...
    def IsHeader(self)->bool:
        ...
        """
        GetDllLibDoc().RowFormat_get_IsHeader.argtypes=[c_void_p]
        GetDllLibDoc().RowFormat_get_IsHeader.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().RowFormat_get_IsHeader,self.Ptr)
        return ret

    @IsHeader.setter
    def IsHeader(self, value:bool):
        GetDllLibDoc().RowFormat_set_IsHeader.argtypes=[c_void_p, c_bool]
        CallCFunction(GetDllLibDoc().RowFormat_set_IsHeader,self.Ptr, value)

    def ClearBackground(self):
        """
        Clears background.
        """
        GetDllLibDoc().RowFormat_ClearBackground.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().RowFormat_ClearBackground,self.Ptr)
