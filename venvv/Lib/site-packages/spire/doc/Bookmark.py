...
class Bookmark(SpireObject):
    ...
    def FirstColumn(self)->int:
        ...
        """
        GetDllLibDoc().Bookmark_get_FirstColumn.argtypes=[c_void_p]
        GetDllLibDoc().Bookmark_get_FirstColumn.restype=c_int
        ret = CallCFunction(GetDllLibDoc().Bookmark_get_FirstColumn, self.Ptr)
        return ret
    ...
    def LastColumn(self)->int:
        ...
        """
        GetDllLibDoc().Bookmark_get_LastColumn.argtypes=[c_void_p]
        GetDllLibDoc().Bookmark_get_LastColumn.restype=c_int
        ret = CallCFunction(GetDllLibDoc().Bookmark_get_LastColumn, self.Ptr)
        return ret