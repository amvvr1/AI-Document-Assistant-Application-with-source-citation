...
class DocumentObjectCollection (  DocumentSerializableCollection, IDocumentObjectCollection) :
    ...
    def Owner(self)->'DocumentObject':
		...
		Returns:
            The owner.
        """
        GetDllLibDoc().DocumentObjectCollection_get_Owner.argtypes=[c_void_p]
        GetDllLibDoc().DocumentObjectCollection_get_Owner.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().DocumentObjectCollection_get_Owner,self.Ptr)
