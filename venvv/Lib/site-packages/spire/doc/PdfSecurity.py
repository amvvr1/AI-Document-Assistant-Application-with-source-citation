...
class PdfSecurity (SpireObject) :
    ...
    def OwnerPassword(self)->str:
        ...
        GetDllLibDoc().PdfSecurity_get_OwnerPassword.restype=c_void_p
        ret = PtrToStr(CallCFunction(GetDllLibDoc().PdfSecurity_get_OwnerPassword,self.Ptr))
        return ret
    ...
    def UserPassword(self)->str:
        ...
        GetDllLibDoc().PdfSecurity_get_UserPassword.restype=c_void_p
        ret = PtrToStr(CallCFunction(GetDllLibDoc().PdfSecurity_get_UserPassword,self.Ptr))
        return ret
