...
class HtmlExportOptions (SpireObject) :
    ...
    def UseMsoSpace(self)->bool:
        ...
        """
        warnings.warn("'HtmlExportOptions.UseMsoSpace' is obsolete: Will be removed", DeprecationWarning)
    ...
    @property
    def ListLabelsType(self)->'HtmlExportListLabelsType':
        """
        Gets the type of the HTML export list labels type.
        """
        GetDllLibDoc().HtmlExportOptions_get_ListLabelsType.argtypes=[c_void_p]
        GetDllLibDoc().HtmlExportOptions_get_ListLabelsType.restype=c_int
        ret = CallCFunction(GetDllLibDoc().HtmlExportOptions_get_ListLabelsType,self.Ptr)
        objwraped = HtmlExportListLabelsType(ret)
        return objwraped

    @ListLabelsType.setter
    def ListLabelsType(self, value:'HtmlExportListLabelsType'):
        """
        Sets the type of the HTML export list labels type.
        """
        GetDllLibDoc().HtmlExportOptions_set_ListLabelsType.argtypes=[c_void_p, c_int]
        CallCFunction(GetDllLibDoc().HtmlExportOptions_set_ListLabelsType,self.Ptr, value.value)

    @property
    def OutputTocWithPageNumbers(self)->bool:
        """
        Gets a switch that determines whether to ouput the document TOC with page numbers.
        """
        GetDllLibDoc().HtmlExportOptions_get_OutputTocWithPageNumbers.argtypes=[c_void_p]
        GetDllLibDoc().HtmlExportOptions_get_OutputTocWithPageNumbers.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().HtmlExportOptions_get_OutputTocWithPageNumbers,self.Ptr)
        return ret

    @OutputTocWithPageNumbers.setter
    def OutputTocWithPageNumbers(self, value:bool):
        """
        Sets a switch that determines whether to ouput the document TOC with page numbers.
        """
        GetDllLibDoc().HtmlExportOptions_set_OutputTocWithPageNumbers.argtypes=[c_void_p, c_bool]
        CallCFunction(GetDllLibDoc().HtmlExportOptions_set_OutputTocWithPageNumbers,self.Ptr, value)