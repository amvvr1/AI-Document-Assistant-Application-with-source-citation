...
class PreferredWidth (SpireObject) :
    ...
    def FromPercent(percent:float)->'PreferredWidth':
        """
        ...
        GetDllLibDoc().PreferredWidth_FromPercent.argtypes=[ c_double]
        GetDllLibDoc().PreferredWidth_FromPercent.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().PreferredWidth_FromPercent, percent)
    ...
    def FromPoints(points:float)->'PreferredWidth':
        """
        ...
        GetDllLibDoc().PreferredWidth_FromPoints.argtypes=[ c_double]
        GetDllLibDoc().PreferredWidth_FromPoints.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().PreferredWidth_FromPoints, points)
        ret = None if intPtr==None else PreferredWidth(intPtr)
        return ret
