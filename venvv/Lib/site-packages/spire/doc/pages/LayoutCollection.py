...
class LayoutCollection ( SpireObject) :
    ...
    def IndexOf(self ,entity:'LayoutElement')->int:
        """
        ...
        GetDllLibDoc().LayoutCollection_IndexOf.argtypes=[c_void_p ,c_void_p]
        GetDllLibDoc().LayoutCollection_IndexOf.restype=c_int
        ret = CallCFunction(GetDllLibDoc().LayoutCollection_IndexOf,self.Ptr, intPtrentity)
        return ret
