...
class Section (  CompositeDocumentObject, ISection, ICompositeObject) :
    """
    ...
    def __init__(self, doc:IDocument):
        ...
        GetDllLibDoc().Section_CreateSectionD.argtypes=[c_void_p]
        GetDllLibDoc().Section_CreateSectionD.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().Section_CreateSectionD,intPdoc)
        super(Section, self).__init__(intPtr)
