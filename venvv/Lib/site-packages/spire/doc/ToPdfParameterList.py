...
class ToPdfParameterList (SpireObject) :
    ...
    @property
    def ExportDocumentStructureTags(self)->bool:
        """
        Gets or sets a value determining whether or not to export document structure tags.
        
        The default value is false.
        """
        GetDllLibDoc().ToPdfParameterList_get_ExportDocumentStructureTags.argtypes=[c_void_p]
        GetDllLibDoc().ToPdfParameterList_get_ExportDocumentStructureTags.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().ToPdfParameterList_get_ExportDocumentStructureTags,self.Ptr)
        return ret

    @ExportDocumentStructureTags.setter
    def ExportDocumentStructureTags(self, value:bool):
        GetDllLibDoc().ToPdfParameterList_set_ExportDocumentStructureTags.argtypes=[c_void_p, c_bool]
        CallCFunction(GetDllLibDoc().ToPdfParameterList_set_ExportDocumentStructureTags,self.Ptr, value)

    @property
    def UseAuthorNameToDisplayCommentLabel(self)->bool:
        """
        Gets or sets a value indicating whether display comment label with the author name.

        The default value is false.
        """
        GetDllLibDoc().ToPdfParameterList_get_UseAuthorNameToDisplayCommentLabel.argtypes=[c_void_p]
        GetDllLibDoc().ToPdfParameterList_get_UseAuthorNameToDisplayCommentLabel.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().ToPdfParameterList_get_UseAuthorNameToDisplayCommentLabel,self.Ptr)
        return ret

    @UseAuthorNameToDisplayCommentLabel.setter
    def UseAuthorNameToDisplayCommentLabel(self, value:bool):
        GetDllLibDoc().ToPdfParameterList_set_UseAuthorNameToDisplayCommentLabel.argtypes=[c_void_p, c_bool]
        CallCFunction(GetDllLibDoc().ToPdfParameterList_set_UseAuthorNameToDisplayCommentLabel,self.Ptr, value)
    
    @property
    def PdfImageCompression(self)->'PdfImageCompression':
        """
        Gets or sets the compression method used for images within the PDF file.
        """
        GetDllLibDoc().ToPdfParameterList_get_PdfImageCompression.argtypes=[c_void_p]
        GetDllLibDoc().ToPdfParameterList_get_PdfImageCompression.restype=c_int
        ret = CallCFunction(GetDllLibDoc().ToPdfParameterList_get_PdfImageCompression,self.Ptr)
        objwraped = PdfImageCompression(ret)
        return objwraped

    @PdfImageCompression.setter
    def PdfImageCompression(self, value:'PdfImageCompression'):
        GetDllLibDoc().ToPdfParameterList_set_PdfImageCompression.argtypes=[c_void_p, c_int]
        CallCFunction(GetDllLibDoc().ToPdfParameterList_set_PdfImageCompression,self.Ptr, value.value)
    ...
    def PageLayout(self)->'PdfPageLayout':
        ...
        """
        GetDllLibDoc().ToPdfParameterList_get_PageLayout.argtypes=[c_void_p]
        GetDllLibDoc().ToPdfParameterList_get_PageLayout.restype=c_int
        ret = CallCFunction(GetDllLibDoc().ToPdfParameterList_get_PageLayout,self.Ptr)
        objwraped = PdfPageLayout(ret)
        return objwraped

    @PageLayout.setter
    def PageLayout(self, value:'PdfPageLayout'):
        GetDllLibDoc().ToPdfParameterList_set_PageLayout.argtypes=[c_void_p, c_int]
        CallCFunction(GetDllLibDoc().ToPdfParameterList_set_PageLayout,self.Ptr, value.value)