...
class Document (  CompositeDocumentObject, IDocument, ICompositeObject) :
    """
...
#
    def FindAllString(self ,matchString:str,caseSensitive:bool,wholeWord:bool)->List['TextSelection']:
        ...
        Args:
            ...
            wholeWord: If True, the match must be a whole word.
    ...
    def Replace(self ,pattern:Regex,replace:str)->int:
        ...
        Args:
            ...
            replace: The string to replace the matched pattern with.
    ...
    def Replace(self ,matchString:str,newValue:str,caseSensitive:bool,wholeWord:bool)->int:
        ...
        Args:
            matchString: The string to match.
            newValue: The string to replace the matched string with.
            caseSensitive: If True, the match is case sensitive.
            wholeWord: If True, the match must be a whole word.
        return: The number of replacements made.
        """
    ...
    def Replace(self ,matchString:str,textSelection:TextSelection,caseSensitive:bool,wholeWord:bool)->int:
        ...
        Args:
            matchString: The string to match.
            textSelection: The TextSelection object to replace the matched string with.
            caseSensitive: If True, the match is case sensitive.
            wholeWord: If True, the match must be a whole word.
        return: The number of replacements made.
        """
    ...
    def Replace(self , matchString:str, newValue:str, options:SearchOptions)->int:
        """
        Replaces all occurrences of the specified string in the text based on the given search options.
        Args:
            parammatchString: The string to search for.param
            paramnewValue: The string to replace the matches with.param
            paramoptions: The search options that define how the replacement is performed (e.g., case sensitivity, whole words only).param
        returns:
        ...
        GetDllLibDoc().Document_ReplaceMNO.argtypes=[c_void_p ,c_char_p,c_char_p,c_void_p]
        GetDllLibDoc().Document_ReplaceMNO.restype=c_int
        ret = CallCFunction(GetDllLibDoc().Document_ReplaceMNO,self.Ptr, matchStringPtr, newValuePtr, intPtroptions)
        return ret
...
#        return ret
    ...
    def Replace(self ,matchString:str,matchDoc:IDocument,caseSensitive:bool,wholeWord:bool)->int:
        ...
        Args:
            matchString: The string to match.
            matchDoc: The IDocument object to replace the matched string with.
            caseSensitive: If True, the match is case sensitive.
            wholeWord: If True, the match must be a whole word.
        return: The number of replacements made.
        """
...
#        return ret
    ...
    def AddListDefinitionReference(self ,listType:'ListType',listName:str)->'ListDefinitionReference':
        """
        Adds a list definition reference using the specified list type and name.

        listType: The type of list (numbered or bullet)
        listName: The name of the list   
        """
        enumlistType:c_int = listType.value
        listNamePtr=StrToPtr(listName)
        GetDllLibDoc().Document_AddListDefinitionReference.argtypes=[c_void_p ,c_int,c_char_p]
        GetDllLibDoc().Document_AddListDefinitionReference.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().Document_AddListDefinitionReference,self.Ptr, enumlistType,listNamePtr)
...
#        return ret
    ...
    def AddStyle(self ,builtinStyle:DefaultTableStyle)->TableStyle:
        """
        Adds a table style to the document based on a built-in style.
        
        Args:
            builtinStyle: The built-in table style to add.
            
        Returns:
            The added table style, or null if not found or could not be created.
        """
        enumbuiltinStyle:c_int = builtinStyle.value

        GetDllLibDoc().Document_AddStyleB.argtypes=[c_void_p ,c_int]
        GetDllLibDoc().Document_AddStyleB.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().Document_AddStyleB,self.Ptr, enumbuiltinStyle)
    ...
    def Unprotect(self ,password:str)->bool:
        ...
        """
        passwordPtr = StrToPtr(password)
        GetDllLibDoc().Document_UnprotectP.argtypes=[c_void_p ,c_char_p]
...
#
    ...
    def ListReferences(self)->'ListCollection':
        """
        Gets the list references of document.
        """
        GetDllLibDoc().Document_get_ListReferences.argtypes=[c_void_p]
        GetDllLibDoc().Document_get_ListReferences.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().Document_get_ListReferences,self.Ptr)
        ret = None if intPtr==None else ListCollection(intPtr)
        return ret
    ...
    def FirstSection(self)->'Section':
        """
        Gets first section of the document.
        """
        GetDllLibDoc().Document_get_FirstSection.argtypes=[c_void_p]
        GetDllLibDoc().Document_get_FirstSection.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().Document_get_FirstSection,self.Ptr)
        ret = None if intPtr==None else Section(intPtr)
        return ret
    ...
    def ClearCloningContexts(self):
        """
        Clears the different document cloning context.
        """
        GetDllLibDoc().Document_ClearCloningContexts.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().Document_ClearCloningContexts,self.Ptr)

    def UpdateParagraphListText(self):
        """
        Updates the text of bullet or list in a paragraph.
        """
        GetDllLibDoc().Document_UpdateParagraphListText.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().Document_UpdateParagraphListText,self.Ptr)

    @property

    def MarkdownExportOptions(self)->'MarkdownExportOptions':
        """
        Gets the Markdown save options.
        """
        GetDllLibDoc().Document_get_MarkdownExportOptions.argtypes=[c_void_p]
        GetDllLibDoc().Document_get_MarkdownExportOptions.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().Document_get_MarkdownExportOptions,self.Ptr)
        ret = None if intPtr==None else MarkdownExportOptions(intPtr)
        return ret


    def ExtractPages(self ,index:int,count:int)->'Document':
        """
        Extract the content of the specified range of pages.
        
        Args:
            index: The index of the first page to extract.
            count: The number of the pages to extracted.
        """
        GetDllLibDoc().Document_ExtractPages.argtypes=[c_void_p ,c_int,c_int]
        GetDllLibDoc().Document_ExtractPages.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().Document_ExtractPages,self.Ptr, index, count)
        ret = None if intPtr==None else Document(intPtr)
        return ret

    @singledispatch
    @staticmethod
    def RegisterHyphenationDictionary(language, arg):
        raise TypeError("Unsupport Type")
    
    @RegisterHyphenationDictionary.register
    def _RegisterHyphenationDictionary(language:str,stream:Stream):
        """
        Registers and loads a hyphenation dictionary for the specified language from a stream. Throws if dictionary cannot
        be read or has invalid format.
        Args:
        ...
        """
        languagePtr = StrToPtr(language)
        intPtrstream:c_void_p = stream.Ptr
        GetDllLibDoc().Document_RegisterHyphenationDictionary.argtypes=[ c_char_p,c_void_p]
        CallCFunction(GetDllLibDoc().Document_RegisterHyphenationDictionary, languagePtr, intPtrstream)
    
    @RegisterHyphenationDictionary.register
    def _RegisterHyphenationDictionary(language:str,fileName:str):
        """
        Registers and loads a hyphenation dictionary for the specified language from file. Throws if dictionary cannot be
        read or has invalid format.
        Args:
            language: A language name, e.g. "en-US". See .NET documentation for "culture name" and RFC 4646 for details.
            fileName: A path to the dictionary file in Open Office format. If this parameter is null or empty string then registered is Null dictionary and callback is not called anymore for this language.
        """
        languagePtr = StrToPtr(language)
        fileNamePtr = StrToPtr(fileName)
        GetDllLibDoc().Document_RegisterHyphenationDictionaryLF.argtypes=[ c_char_p,c_char_p]
        CallCFunction(GetDllLibDoc().Document_RegisterHyphenationDictionaryLF, languagePtr,fileNamePtr)
    
    
    @staticmethod

    def UnregisterHyphenationDictionary(language:str):
        """
        ...
        """
        languagePtr = StrToPtr(language)
        GetDllLibDoc().Document_UnregisterHyphenationDictionary.argtypes=[ c_char_p]
        CallCFunction(GetDllLibDoc().Document_UnregisterHyphenationDictionary, languagePtr)

    @staticmethod

    def IsHyphenationDictionaryRegistered(language:str)->bool:
        """
        Returns False if for the specified language there is no dictionary registered or if registered is Null dictionary,
        True otherwise.
        """
        languagePtr = StrToPtr(language)
        GetDllLibDoc().Document_IsHyphenationDictionaryRegistered.argtypes=[ c_char_p]
        GetDllLibDoc().Document_IsHyphenationDictionaryRegistered.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().Document_IsHyphenationDictionaryRegistered, languagePtr)
        return ret